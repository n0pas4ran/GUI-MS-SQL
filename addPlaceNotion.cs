...
namespace client
{
    public partial class addPlaceNotion : Form
    {
        string log, pass;
        string[] surnames;
        int[] inns;
        DataTable dt;
        public addPlaceNotion(string login, string password)
        {
            log = login;
            pass = password;
        ...
        private void placeAddNotion_Load(object sender, EventArgs e)
        {
        ...
        private void returnButton_Click(object sender, EventArgs e)
        {
            ...
            form.rb_click = true;
            form.ab_Click(knpBox.Text, Convert.ToDouble(squareBox.Text), inn);
            this.Close();
